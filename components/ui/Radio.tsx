        ...
        <div className="flex items-center gap-2.5">
          <div className="relative flex items-center h-5">
            <input
              ...
              className={cn(
                "h-4 w-4 rounded-full border text-primary focus:ring-primary focus:ring-offset-1 focus:outline-none transition-all duration-150 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
